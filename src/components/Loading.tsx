...
const Loading: React.FC<Props> = ({chatMessage, message, style }) => {
  return (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse" style={{animationDelay:"0ms"}}/>
                  <div className="w-3 h-3 bg-yellow-500 rounded-full animate-pulse" style={{animationDelay:"5ms"}}/>
                  <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse" style={{animationDelay:"10ms"}}/>
                </div>
                <div className="text-xs text-slate-500 font-poppins font-medium">Loading <VscLoading className="inline-flex ml-1 animate-spin"/></div>
              </div>
              ...
              <div className="space-y-4 text-xs sm:text-sm text-slate-700">
                ...
                <div className={`bg-blue-100 text-blue-700 ${style} w-fit py-3 px-4 rounded-2xl font-poppins rounded-bl-sm`}>
                 {chatMessage || 'Loading echooo...'}
                </div>
                <p className="mt-4 px-5 text-[10px] sm:text-xs text-center font-poppins text-slate-500">
